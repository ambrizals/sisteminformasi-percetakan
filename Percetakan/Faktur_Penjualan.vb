...
Public Class Faktur_Penjualan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Percetakan.Faktur_Penjualan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFaktur_Penjualan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Faktur_Penjualan = New Faktur_Penjualan()
        rpt.Site = Me.Site
        Return rpt
    End Function
