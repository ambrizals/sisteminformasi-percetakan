Public Class FormLaporanPesanan
    Private Sub Btn_Filter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Filter.Click
        CrystalReportViewer1.SelectionFormula = "{Command.logDATE} >= date('" & Format(dt_awal.Value, "dd/MM/yyyy") & "') and {Command.logDATE} <= date('" & Format(dt_akhir.Value, "dd/MM/yyyy") & "')"
    ...
    Private Sub FormLaporanPesanan_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        dt_awal.Value = Today
    End Sub
End Class